...
const TechStack = () => {
  ...
  // turn on physics only when section is in view
  useEffect(() => {
    const handleScroll = () => {
      ...
      // tweak this threshold if you want earlier/later activation
      const isVisible = rect.top < vh * 0.8 && rect.bottom > vh * 0.2;
  ...
  return (
    <div ref={sectionRef} className="techstack">
      ...
      {/* <p className="subtitle">Technologies I use to build fast and modern experiences.</p> */}
